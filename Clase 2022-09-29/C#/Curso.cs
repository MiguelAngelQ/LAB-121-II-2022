...
namespace Herencia_LAB_121{
	...
	public class Curso{
		...
		public void mostrar() {
			...
			Console.WriteLine("nomDirector: " + nomDirector);
			Console.WriteLine("nroDistrito: " + nroDistrito);
			Console.WriteLine("ciudad: " + ciudad);
			Console.WriteLine("nroEstudiantes: " + nroEstudiantes);
			for (int i = 0; i < nroEstudiantes; i++) {
				Console.WriteLine("\tNomEstudiante: " + estudiantes[0,i]);
				Console.WriteLine("\tCiEstudiante: " + estudiantes[1,i]);
				Console.WriteLine("\tEdadEstudiante: " + estudiantes[2,i]);
			}
			Console.WriteLine("nomProfesor: " + nomProfesor);
			Console.WriteLine("ciProfesor: " + ciProfesor);
		}
		
		public int cantidadEstudiantesMayoresDeEdad() {
			int cont = 0;
			for (int i = 0; i < nroEstudiantes; i++) {
				if (Convert.ToInt32(estudiantes[2, i]) >= 18)
					cont += 1;
			}
			return cont;
		}
